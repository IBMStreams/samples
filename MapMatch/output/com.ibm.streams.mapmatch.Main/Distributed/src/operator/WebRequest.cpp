...
MY_OPERATOR_SCOPE::MY_OPERATOR::MY_OPERATOR()
{
  ...
  */
     osi->setParameter(env, setup, "className", SPL::rstring("com.ibm.streamsx.inet.rest.ops.PostTuple"));
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("WebRequest",&initer));
    return true;
}
...
MY_BASE_OPERATOR::MY_BASE_OPERATOR()
 : Operator() {
    ...
    param$className$0 = SPL::rstring("com.ibm.streamsx.inet.rest.ops.PostTuple");
